...
def dump():
    ...
    dict = {"city": "上海", "name": "grubby"}
    json.dump(list, open("C://Users/qmtv/Documents/list.json", "w"), ensure_ascii=False)
    json.dump(dict, open("C://Users/qmtv/Documents/dict.json", "w"), ensure_ascii=False)
...
"""
def load():
    list_str = json.load(open("C://Users/qmtv/Documents/list.json"))
    dict_str = json.load(open("C://Users/qmtv/Documents/dict.json"))
...
def lagou():
    ...
    # 写入本地文件
    with open("C://Users/qmtv/Documents/city.json", "w") as f:
        f.write(array)
